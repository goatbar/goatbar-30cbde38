      ...
      <main>
        <section className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.2fr_0.8fr] lg:py-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="#solicitar"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-primary px-5 font-bold text-primary-foreground"
              >
                Solicitar orçamento <ArrowRight className="h-4 w-4" />
              </a>
              <a
                href="#como-funciona"
                className="inline-flex h-12 items-center justify-center rounded-lg border border-border bg-surface px-5 font-semibold"
              >
                Como funciona
              </a>
            </div>
        ...
        <section id="solicitar" className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:py-24">
          <div className="rounded-3xl border border-border bg-surface p-6 text-center sm:p-10">
            <h2 className="font-display text-3xl font-bold">Vamos criar uma experiência inesquecível para o seu evento?</h2>
            <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
              Clique abaixo para iniciar sua solicitação. O formulário completo continuará no fluxo público de orçamento da Goat Bar.
            </p>
            <div className="mt-8">
              <Link
                to="/orcamento/solicitar/$token"
                params={{ token: "novo" }}
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-primary px-6 font-bold text-primary-foreground"
              >
                Solicitar orçamento <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
            <p className="mt-4 text-xs text-muted-foreground">
              Ao continuar, seus dados serão usados somente para contato e atendimento da sua solicitação de orçamento.
            </p>
          </div>
        </section>
      </main>
