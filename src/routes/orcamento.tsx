      ...
      <main>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:py-24">
          <div className="rounded-3xl border border-border bg-surface p-8 sm:p-12">
            <h2 className="font-display text-3xl font-bold">Conte como será o seu evento</h2>
            <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
              Abra o formulário completo de solicitação, escolha os drinks que mais combinam com o evento e envie todas as informações para nossa equipe.
            </p>
            <a
              href="/orcamento/solicitar"
              className="mt-7 inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-primary px-6 font-bold text-primary-foreground"
            >
              Solicitar orçamento <ArrowRight className="h-4 w-4" />
            </a>
          </div>
