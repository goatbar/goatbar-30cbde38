...
export const drinks: Drink[] = [
  ...
  },
  {
    ...
    insumos: [
      { nome: "Vodka", custo: 2.0 },
      { nome: "Abacaxi", custo: 0.5 },
      { nome: "Raspas", custo: 0.3 },
    ],
    modalityConfig: {
      evento: { active: true, cost: 2.8 },
      steakhouse: { active: true, cost: 15.4, price: 30 },
  ...
  },
  {
    ...
    custoUnitario: 9.7,
    insumos: [
      { nome: "Vermute", custo: 2.2 },
      { nome: "Gin", custo: 4.0 },
      { nome: "Campari", custo: 3.5 },
    ],
    modalityConfig: {
      evento: { active: true, cost: 9.7 },
  ...
  },
  {
    ...
    insumos: [
      ...
      { nome: "Coulis", custo: 0.0 },
      { nome: "Espuma", custo: 0.0 },
    ],
    modalityConfig: {
      evento: { active: true, cost: 4.0 },
      steakhouse: { active: false, cost: 0 },
  ...
  },
  {
    ...
    custoUnitario: 3.7,
    insumos: [
      { nome: "Xarope", custo: 2.2 },
      { nome: "Vodka", custo: 2.0 },
    ],
    modalityConfig: {
      evento: { active: true, cost: 3.7 },
      steakhouse: { active: true, cost: 20.7, price: 40 },
      goatbotequim: { active: false, cost: 0 },
    },
    imagem:
  ...
  // --- DOSES BOTEQUIM ---
  {
    ...
    modalityConfig: {
      evento: { active: false, cost: 0 },
      steakhouse: { active: false, cost: 0 },
      goatbotequim: { active: true, cost: 1.5, price: 7.0 },
    },
    imagem:
      "https://images.unsplash.com/photo-1595981267035-7b04ca84a82d?w=400&auto=format&fit=crop",
  },
  {
    ...
    custoUnitario: 3.0,
    insumos: [{ nome: "Vodka", custo: 3.0 }],
    modalityConfig: {
      evento: { active: false, cost: 0 },
      steakhouse: { active: false, cost: 0 },
      goatbotequim: { active: true, cost: 3.0, price: 14.0 },
    },
    imagem:
      "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400&auto=format&fit=crop",
  },
  ...
  },
  {
    ...
    custoUnitario: 10.0,
    insumos: [{ nome: "Whisky", custo: 10.0 }],
    modalityConfig: {
      evento: { active: false, cost: 0 },
      steakhouse: { active: false, cost: 0 },
  ...
  },
  {
    ...
    custoUnitario: 7.0,
    insumos: [{ nome: "Campari", custo: 7.0 }],
    modalityConfig: {
      evento: { active: false, cost: 0 },
      steakhouse: { active: false, cost: 0 },
...
export const contractTemplates: ContractTemplate[] = [
  {
    ...
    fileType: "docx",
    isDefault: true,
    variablesSchema: ["nome_cliente", "valor_total_evento"],
...
export const parametros: ParametroCalculo[] = [
  ...
  {
    id: "p2",
    chave: "custo_equipe_hora",
    label: "Custo de equipe por hora",
    valor: 65,
    unidade: "R$",
    groupo: "Custos",
  },
  {
    id: "p3",
    chave: "custo_operacional_evento",
    label: "Custo operacional fixo por evento",
    valor: 850,
    unidade: "R$",
    groupo: "Custos",
  },
  ...
  },
  {
    id: "p6",
    chave: "quebra_copos",
    label: "Quebra de copos por 100 convidados",
    valor: 6,
    unidade: "un",
    groupo: "Operacional",
  },
  ...
  {
    id: "p8",
    chave: "gelo_kg_pessoa",
    label: "Gelo por convidado",
    valor: 1.2,
    unidade: "kg",
    groupo: "Consumo",
  },
  {
    id: "p9",
    chave: "insumos_pessoa",
    label: "Insumos por convidado",
    valor: 4.5,
    unidade: "R$",
    groupo: "Consumo",
  },
  {
    id: "p10",
    chave: "markup_eventos",
    label: "Markup Eventos",
    valor: 3.5,
    unidade: "x",
    groupo: "Precificação",
  },
  {
    id: "p11",
    chave: "markup_7steakhouse",
    label: "Markup 7Steakhouse",
    valor: 3.0,
    unidade: "x",
    groupo: "Precificação",
  },
  {
    id: "p12",
    chave: "markup_goatbotequim",
    label: "Markup Goat Botequim",
    valor: 2.8,
    unidade: "x",
    groupo: "Precificação",
  },
...
export function calcularOrcamentoEvento(evento: Evento, drinksList: Drink[] = drinks) {
  ...
  // --- EQUIPE ---
  const valorEquipe = Object.values(evento.equipe || {}).reduce(
    (acc, p) => acc + (Number(p.qtd) || 0) * (Number(p.valorUnitario) || 0),
    0,
  );
  ...
  // --- GASTOS DIVERSOS ---
  const valorGastosDiversos = (evento.gastosDiversos || []).reduce(
