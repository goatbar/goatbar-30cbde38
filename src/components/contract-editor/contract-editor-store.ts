...
export const EDITOR_FIELD_CATEGORIES: FieldCategoryDef[] = [
  {
    ...
    fields: [
      ...
      { key: "evento.valor_por_pessoa", label: "Valor por Pessoa", category: "Evento", desc: "Valor individual calculado do orçamento", sampleValue: "R$ 45,33", defaultTag: "[VALOR_POR_PESSOA]" },
    ],
  },
  {
    category: "👤 Cliente",
  ...
  },
  {
    ...
    icon: DollarSign,
    fields: [
      { key: "financeiro.valor_total", label: "Valor Total do Contrato", category: "Financeiro", desc: "Valor total do orçamento", sampleValue: "R$ 6.800,00", defaultTag: "[VALOR_TOTAL]" },
      { key: "financeiro.valor_entrada", label: "Valor Pago na Entrada", category: "Financeiro", desc: "Valor do sinal/sinalizador", sampleValue: "R$ 3.400,00", defaultTag: "[VALOR_ENTRADA]" },
      { key: "financeiro.valor_restante", label: "Valor Restante (Calculado)", category: "Financeiro", desc: "Valor Total - Valor Entrada", sampleValue: "R$ 3.400,00", defaultTag: "[VALOR_RESTANTE]" },
      { key: "financeiro.forma_pagamento", label: "Forma de Pagamento", category: "Financeiro", desc: "Interpretada automaticamente", sampleValue: "50% no ato + 50% até 7 dias antes", defaultTag: "[FORMA_PAGAMENTO]" },
