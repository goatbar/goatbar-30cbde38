...
export const ASSINAFY_BASE_URL = ASSINAFY_ENV === "production" 
...
export async function createAssignment(documentId: string, signers: {id: string, verification_method?: string, notification_methods?: string[]}[]) {
    const url = `${ASSINAFY_BASE_URL}/v1/documents/${documentId}/assignments`;
    const payload = { method: "virtual", signers };
